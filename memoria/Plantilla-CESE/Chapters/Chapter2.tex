...
El diagrama Activity on Node final del proyecto se observa en la figura \ref{fig:none}'', en esta se puede apreciar el orden seguido para la ejecución de las tareas, las cuales en total suman 710 horas.
